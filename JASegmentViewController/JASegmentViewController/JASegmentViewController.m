...
- (void)viewDidLoad {
    ...
    NSArray *titleArray = [[NSArray alloc]initWithObjects:@"详情",@"节目",@"已下载",/*@"1",@"2",@"3",@"4",*/ nil];
    ...
    _titleView = [[JAPageTitleView alloc]initWithFrame:CGRectMake(0, titleViewY, [[UIScreen mainScreen]bounds].size.width, titleViewHeight) titles:titleArray needBottomLine:YES delegate:self];
...
//    DownloadViewController *downloadVC4 = [DownloadViewController new];
    ...
    _contentView = [[JAPageContentView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(_titleView.frame), [[UIScreen mainScreen]bounds].size.width, [[UIScreen mainScreen]bounds].size.height - kStatusBarHeight - kNavToolBarHeight - height - titleViewHeight) childVCs:childVCs parentVC:self delegate:self];
